...
<body id="page-top">
	...
	<div id="wrapper">
            ...
            <li class="nav-item ">
              ...
              <div id="collapse1" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                  <div class="bg-white py-2 collapse-inner rounded">
                      ...
                      <a class="collapse-item" href="/student/registration">Course Registration</a>
                      <a class="collapse-item" href='/student/pre-req'>Courses Pre-requisite</a>
                      <a class="collapse-item" href='/student/dropcourse'>Drop Course</a>
                  </div>
              </div>
				...
				<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item dropdown no-arrow">
							<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="mr-2 d-none d-lg-inline text-gray-600 small">Mostafa Nawam</span> <img class="img-profile rounded-circle" src="{{asset('images/avt-img.jpg')}}"> </a>
		...
		<script src="{{asset('js/sb-admin-2.min.js')}}"></script> @livewireScripts </body>
